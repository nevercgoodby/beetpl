    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="login-form" action="index.html" method="post">
                ...
                <div class="form-actions">
                    <label class="checkbox">
                        <input type="checkbox" name="remember" value="1" /> 保持登录状态 </label>
                ...
                <div class="forget-password">
                    <p> 忘记密码 ? 请不要担心，点击
                        <a href="javascript:;" id="forget-password"> 这里 </a> 重新设置您的密码。 </p>
                </div>
            ...
            <form class="forget-form" action="index.html" method="post">
                <h3>忘记密码了?</h3>
                <p> 请输入你账户的邮箱来重新设置密码！ </p>
                <div class="form-group">
                    <div class="input-icon">
                        <i class="fa fa-envelope"></i>
                        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="注册时的邮箱 如abc@123.com" name="email" /> </div>
                </div>
                <div class="form-actions">
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> 2015 &copy; 公司名. </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
